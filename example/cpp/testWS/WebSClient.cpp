...
break;
case WEBSCLIENT_BEHAVIOR_STARTED_STATE:
{
...
if (_instance->WebSClient_behavior_State == WEBSCLIENT_BEHAVIOR_STARTED_STATE) {
if (1) {
_instance->WebSClient_client_var->sendMessage(msg);
}
}
}
...
_instance->WebSClient_behavior_State = WEBSCLIENT_BEHAVIOR_STARTED_STATE;
WebSClient_behavior_OnEntry(WEBSCLIENT_BEHAVIOR_STARTED_STATE, _instance);
}
}
...
if (_instance->WebSClient_behavior_State == WEBSCLIENT_BEHAVIOR_STARTED_STATE) {
if (1) {
WebSClient_behavior_OnExit(WEBSCLIENT_BEHAVIOR_STARTED_STATE, _instance);
