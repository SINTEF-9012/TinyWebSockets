...
break;
case WEBSMIRRORSERVER_BEHAVIOR_STOP_STATE:
_instance->WebSMirrorServer_server_var->close();
break;
case WEBSMIRRORSERVER_BEHAVIOR_START_STATE:
{
fprintf(stdout, "\tserver attempts to start\n");
...
_instance->WebSMirrorServer_behavior_State = WEBSMIRRORSERVER_BEHAVIOR_STOP_STATE;
WebSMirrorServer_behavior_OnEntry(WEBSMIRRORSERVER_BEHAVIOR_STOP_STATE, _instance);
}
}
else if (_instance->WebSMirrorServer_behavior_State == WEBSMIRRORSERVER_BEHAVIOR_START_STATE) {
if (1) {
WebSMirrorServer_behavior_OnExit(WEBSMIRRORSERVER_BEHAVIOR_START_STATE, _instance);
_instance->WebSMirrorServer_behavior_State = WEBSMIRRORSERVER_BEHAVIOR_START_STATE;
WebSMirrorServer_behavior_OnEntry(WEBSMIRRORSERVER_BEHAVIOR_START_STATE, _instance);
}
}
}
...
if (_instance->WebSMirrorServer_behavior_State == WEBSMIRRORSERVER_BEHAVIOR_STOP_STATE) {
if (1) {
WebSMirrorServer_behavior_OnExit(WEBSMIRRORSERVER_BEHAVIOR_STOP_STATE, _instance);
_instance->WebSMirrorServer_behavior_State = WEBSMIRRORSERVER_BEHAVIOR_START_STATE;
WebSMirrorServer_behavior_OnEntry(WEBSMIRRORSERVER_BEHAVIOR_START_STATE, _instance);
}
}
